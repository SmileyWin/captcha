...
//            File verifyImageImport = new File(verificationImagePathPrefix);
            File verifyImageImport = ResourceUtils.getFile(verificationImagePathPrefix);
            ...
            //  获取模板图片文件
            File templatePrefixFile = ResourceUtils.getFile(templateImagePathPrefix);
            File templateImageFile = new File(templatePrefixFile.getPath() + "/template.png");

            //  获取描边图片文件
            File borderImageFile = new File(templatePrefixFile.getPath() + "/border.png");
            //  获取描边图片类型
