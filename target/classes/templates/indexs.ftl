...
<head>
    ...
    <style>
        ...
        .imgBtn{ width:44px; height: 171px; position: absolute; left: 0; top:700px;}
...
<script>
    ...
    $(".comImageValidate").ready(function () {
        validateImageInit("char");
        validateImageInit("operation");
        validateImageInit("slide");
    ...
    function validateImageInit(type) {
        var url = "/captcha/get/verification/image";
        if (type != null) {
            url += "?type=" + type;
        }
